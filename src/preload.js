...
contextBridge.exposeInMainWorld('browserAPI', {
    ...
    type: (text) => ipcRenderer.invoke('automation:type', text),
    mouseMove: (x, y) => ipcRenderer.invoke('automation:mouseMove', x, y),
    getGlobalCursorPosition: () => ipcRenderer.invoke('automation:getCursorPosition'),
    getChromeHeight: () => ipcRenderer.invoke('automation:getChromeHeight'),
    ...
    getViewSize: () => ipcRenderer.invoke('automation:getViewSize'),
});
